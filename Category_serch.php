...
<body>
    ...
    <!-- start #main-site -->
      <main id="main-site">
      <table>
        <form action="List_of_narrowed_down_products.php?category=0" method="post">
            <tr>
                <td><input type="submit" value="CPU"></td>
            </tr>
        </form>
        <form action="List_of_narrowed_down_products.php?category=1" method="post">
            <tr>
                <td><input type="submit" value="GPU"></td>
            </tr>
        </form>
        <form action="List_of_narrowed_down_products.php?category=2" method="post">
            <tr>
                <td><input type="submit" value="memory"></td>
            </tr>
        </form>
    </table>
        <!-- Owl-carousel -->
